...
import golbang.com.bluled.Bluetooth.BluetoothManager;
import golbang.com.bluled.Bluetooth.ConnectionInfo;
import golbang.com.bluled.Bluetooth.TransactionBuilder;
import golbang.com.bluled.Bluetooth.TransactionReceiver;
import golbang.com.bluled.Utils.Constants;

/**
 * Created by yoosung-jong on 14. 11. 11..
 */
public class BluLedService extends Service{
    ...
    public class BTServiceBinder extends Binder {
        public BluLedService getService() {
            Log.d(TAG,"getService");
            return BluLedService.this;
        }
    }
